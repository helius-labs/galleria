      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="group mb-8 flex justify-center">
          <div className="relative flex items-center rounded-full border border-white border-opacity-20 bg-opacity-25 px-3 py-1 text-sm leading-6 text-white transition-all duration-200 ease-in-out hover:bg-black/10 group-hover:border-opacity-60 group-hover:bg-opacity-75">
            ...
            <a href="#" className="flex items-center font-semibold text-accent">
        ...
        <div className="text-center">
          ...
          <div className="mt-16">
            ...
            >
              <span className="rounded-full bg-indigo-100/5 px-3 py-1 text-sm font-semibold leading-6 text-accent ring-1 ring-inset ring-accent/10 group-hover:ring-accent/30 transition duration-200 ease-in-out">
                What&apos;s Helius?
              </span>
